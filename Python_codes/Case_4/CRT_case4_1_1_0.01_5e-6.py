            ...
            for w in weights:
                for tim in times:
                    ...
                    for j in range(5):
                        ...
                        np.savetxt(
                            "Case4_" + str(Cin) + "_" + str(Cout) + "_" + str(b1) + "_" + str(b2) + str(radius0) + "_" + str(radius2) + "_" + str(w) + '_' + str(j + 1) + '_' + str(
                        ...
                        plt.legend()
                        plt.savefig(
                            'Case4_' + str(Cin) + "_" + str(Cout) + "_" + str(b1) + "_" + str(b2) + "_"+ str(radius0) + "_" + str(radius2) + '_' + str(w) + '_' + str(j + 1) + '_' + str(
                                tim) + '.png')
